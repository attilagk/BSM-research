...
schizophrenia.  Fig~S\ref{fig:d-separation}A illustrates that.  The important consequence is
...
inference on the effect of Dx on enrichment (Fig~S\ref{fig:d-separation}B).
