...
\includegraphics[width=1.0\columnwidth]{../../notebook/2021-01-26-indiv-counts-modeling/named-figure/relcallrates-betas-binom-chisq-pvalues.pdf}
\end{frame}

\begin{frame}{Summary}
\begin{itemize}
\item we developed a new pipeline for calling somatic SNVs from WGS data
