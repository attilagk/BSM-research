...
\begin{columns}[t]
\begin{column}{0.5\textwidth}
Genesets enriched in \alert{disruptive} variants
\begin{itemize}
\item PSD
\item FMRP-target
...
\begin{frame}{Enrichment is selective to coding regions}
\begin{center}
...
\end{itemize}
\item insufficient data to study enrichment in disruptive variants
\begin{itemize}
