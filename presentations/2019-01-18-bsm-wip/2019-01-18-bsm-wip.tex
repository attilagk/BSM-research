...
\begin{frame}
\includegraphics[width=1.0\textwidth]{figures/from-others/bsm-science-fig1.jpg}
\end{frame}
...
\includegraphics[width=0.7\columnwidth]{figures/2017-05-24-alignment-stats/depth-hist-1.pdf}
\end{frame}
