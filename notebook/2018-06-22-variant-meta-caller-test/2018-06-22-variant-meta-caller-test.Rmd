...
The `strelka2Somatic-addGT` script solve that problem by adding GT 0/1 for TUMOR and GT 0/0 for NORMAL. This is, of course, a simplification which ignores the typically mixed genotypes in the tumor sample.  But it seems to be a reasonable simplification based on the following analysis.
