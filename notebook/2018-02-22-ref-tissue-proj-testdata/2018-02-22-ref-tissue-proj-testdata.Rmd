...
xyplot(runtime / 60 ~ numcores | length, data = runt, groups = caller, subset = length %in% c("1MB", "10MB"), ylab = "runtime, min", xlab = "number of cores", grid = TRUE, main = "Runtime at 1MB length", auto.key = TRUE, type = "b", pch = 21, lty = 2)
```
