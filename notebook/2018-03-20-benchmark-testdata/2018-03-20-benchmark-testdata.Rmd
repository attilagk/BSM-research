...
```{r}
# manually set Tnseq runtime based on failed run as long as run with fixed Tnseq version is not completed
# see wgs/32proc/Tnseq-v201711-run.time
runt[6, "runtime"] <- 60 * 5258 + 45.905
```

Below are the runtimes.  Tnseq is much slower than strelka2Somatic or strelka2Germline on both the small and the WGS data set.
