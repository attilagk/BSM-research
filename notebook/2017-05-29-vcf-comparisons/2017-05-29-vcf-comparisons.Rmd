...
my.venn3(dir = "1_isec-callers/NeuN_mn-NeuN_pl/snvs/", cls = clsets1)
```
...
my.venn3(dir = "1_isec-callers/NeuN_mn-NeuN_pl/indels/", cls = clsets1)
```
...
my.venn3(dir = "1_isec-callers/muscle-NeuN_pl/snvs/", cls = clsets1)
```

#### muscle--NeuN_pl, indels

```{r venn-caller-muscle-neun_pl-indels, echo=FALSE}
my.venn3(dir = "1_isec-callers/muscle-NeuN_pl/indels/", cls = clsets1)
```

#### muscle--NeuN_mn, SNVs

```{r venn-caller-muscle-neun-mn-snvs, echo=FALSE}
my.venn3(dir = "1_isec-callers/muscle-NeuN_mn/snvs/", cls = clsets1)
```

#### muscle--NeuN_mn, indels

```{r venn-caller-muscle-neun-mn-indels, echo=FALSE}
my.venn3(dir = "1_isec-callers/muscle-NeuN_mn/indels/", cls = clsets1)
```
...
my.venn2(dir = "results/mutect2-unfilt/2_cmp-reftissues/snvs/", cls = clsets1,
...
my.venn2(dir = "results/mutect2-unfilt/2_cmp-reftissues/indels/", cls = clsets1,
             category = c("NeuN_mn", "muscle"), col = my.cols <- c("gray", "rosybrown"), fill = my.cols)
```
...
my.venn2(dir = "results/mutect2-PASS/2_cmp-reftissues/snvs/", cls = clsets1,
             category = c("NeuN_mn", "muscle"), col = my.cols <- c("gray", "rosybrown"), fill = my.cols)
```
...
my.venn2(dir = "results/mutect2-PASS/2_cmp-reftissues/indels/", cls = clsets1,
             category = c("NeuN_mn", "muscle"), col = my.cols <- c("gray", "rosybrown"), fill = my.cols)
```
